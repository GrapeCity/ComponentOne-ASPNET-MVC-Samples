...
namespace FlexViewerExplorer.Models
{
    public class Documents
    {
        ...
        private static Documents _ssrsReports = new Documents("~\\Content\\SsrsReportInfos.xml", "c1ssrs", DocumentItem.DocumentKindSsrsReport);
        private static Documents _pdfs = new Documents("~\\Content\\PdfInfos.xml", "PdfsRoot", DocumentItem.DocumentKindPdf);
        private static Documents _arReports = new Documents("~\\Content\\ArReportInfos.xml", "", DocumentItem.DocumentKindArReport);
        ...
        private void InitItems()
        {
            ...
            var docInfos = XElement.Load(HttpContext.Current.Server.MapPath(_xmlFilePath));
