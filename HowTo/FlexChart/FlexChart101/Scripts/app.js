...
function InitialControls() {
    ...
    //cbSales.addEventListener('click', function () {
    //    //chartLegendToggle.series[index].visibility = this.checked;
    //    if (this.checked) {
    //        chartLegendToggle.series[0].visibility = wijmo.chart.SeriesVisibility.Visible;
    //    }
    //    else {
    //        chartLegendToggle.series[0].visibility = wijmo.chart.SeriesVisibility.Legend;
    //    }
    //});
