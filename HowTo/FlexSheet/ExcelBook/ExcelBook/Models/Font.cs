...
namespace ExcelBook.Models
{
    public class FontName
    {
        public string Name { get; set; }
        public string Value { get; set; }
        private static List<FontName> _FONT_NAME_LIST;

        public static List<FontName> GetFontNameList()
        {
            if (_FONT_NAME_LIST == null)
            {
                _FONT_NAME_LIST = new List<FontName>{
    ...
    public class FontSize
    {
        public string Name { get; set; }
        public string Value { get; set; }
        private static List<FontSize> _FONT_SIZE_LIST;

        public static List<FontSize> GetFontSizeList()
        {
            if (_FONT_SIZE_LIST == null)
            {
                _FONT_SIZE_LIST = new List<FontSize>{ 
