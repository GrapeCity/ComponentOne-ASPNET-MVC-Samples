           ...
           */
            ...
            */
                ...
                if (hi != null && hi.cellType == wijmo.grid.CellType.Cell) {
                    if (!e.ctrlKey) {
                        ...
                        setTimeout(function () {
                            ...
                            // TFS 433436
                            if (!seft._pageSelectedIndexes[pi]) {
                                var ps_1 = [];
                                seft._grid.selectedRows.forEach(function (element) {
                                    ps_1.push(element.index);
                                });
                                seft._pageSelectedIndexes[pi] = ps_1;
                            }
                            seft._syncText();
            ...
            MultiColumnComboBox.prototype._keydown = function (e) {
                ...
                switch (e.keyCode) {
                    case wijmo.Key.Enter:
                        ...
                        if (!this._pageSelectedIndexes[currentPage]) {
                            var ps_1 = [];
            ...
            MultiColumnComboBox.prototype._queryData = function (s, e) {
                ...
                //if (this._query != "") {// TFS 433440 Case 2
