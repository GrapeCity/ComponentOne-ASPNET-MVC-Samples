...
function relayout() {
    if (document.querySelector(".maximum") != null)
    {
        return;
    }
...
function gaugeRefreshing(sender, e) {
    var eleGauge = sender.hostElement,
        ...
        eleTile = wijmo.closest(eleTileGauge, '.wj-li-content'),
        eleTitle = eleGaugeContainer.querySelector('.gauge-title');

    eleGauge.style.width = (eleGaugeContainer.parentNode.offsetWidth - 100) + 'px';
    var gaugesTotalHeight = eleTileGauge.parentElement.getBoundingClientRect().height;
