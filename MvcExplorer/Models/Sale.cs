...
namespace MvcExplorer.Models
{
    public class Sale
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Start_Required_ErrorMessage")]
        [DataType(DataType.DateTime, ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Start_DataType_ErrorMessage")]                     
        public DateTime Start { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "EndTime_Required_ErrorMessage")]
        public DateTime End { get; set; }
        public string Country { get; set; }
        public string Product { get; set; }
        public string Color { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Change_Required_ErrorMessage")]
        public double Amount { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Price_Required_ErrorMessage")]
        [RegularExpression(pattern: @"^\$?[0-9]\d*(\.\d+)?$", ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Price_DataType_ErrorMessage")]
        public double Amount2 { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Discount_Required_ErrorMessage")]
        [RegularExpression(pattern: @"^[0-9]\d*(\.\d+)?\%?$", ErrorMessageResourceType = typeof(Resources.Validation), ErrorMessageResourceName = "Discount_DataType_ErrorMessage")]
